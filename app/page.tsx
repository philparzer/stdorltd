...
export default function Home() {
  return (
    <main className="flex items-center justify-center min-h-screen flex-col text-center">
      ...
      <p className="">Is the following abbreviation <span className="font-medium">a limited liability company in Europe</span> or a <span className="font-medium">medical condition</span>?</p>
      <p className="text-sm text-black/50">to make this a little harder we added punctuation to some our medical terms e.g. HIV might look like h.i.v.</p>
      </div>
    <Quiz />
    </main>
  );
